...
!(function (e, t) {
  ...
  var ee,
    te =
      ((ee = 'undefined' != typeof Uint8Array && R(Uint8Array)),
      function (e) {
  ...
  var ae,
    ...
    he = {
      ...
      isSpecCompliantForm: function (e) {
        return !!(e && F(e.append) && 'FormData' === e[j] && e[k])
      },
  ...
  ;([
    ...
    (de.from = function (e, t, r, n, o, i) {
      ...
      return (
        de.call(a, s, u, r, n, o),
        e && null == a.cause && Object.defineProperty(a, 'cause', { value: e, configurable: !0 }),
  ...
  function Ee(e, t, r) {
    ...
    function u(e) {
      ...
      if (he.isBoolean(e)) return e.toString()
    ...
    function c(e, r, o) {
      var s = e
      if (e && !o && 'object' === f(e))
        if (he.endsWith(r, '{}')) ((r = n ? r : r.slice(0, -2)), (e = JSON.stringify(e)))
        else if (
          (he.isArray(e) &&
            (function (e) {
          ...
          return (
            ...
            s.forEach(function (e, n) {
              !he.isUndefined(e) &&
                null !== e &&
                t.append(!0 === a ? ge([r], n, i) : null === a ? r : r + '[]', u(e))
            }),
            !1
          )
    ...
    var l = [],
      p = Object.assign(we, { defaultVisitor: c, convertValue: u, isVisitable: me })
            ...
            he.forEach(r, function (r, i) {
              !0 ===
                (!(he.isUndefined(r) || null === r) &&
                  o.call(t, r, he.isString(i) ? i.trim() : i, n, p)) && e(r, n ? n.concat(i) : [i])
            }),
            l.pop())
        }
      })(e),
  ...
  function Ye(e, t) {
    ...
    return [
      function () {
        for (
          var e = Date.now(), t = e - o, s = arguments.length, u = new Array(s), c = 0;
          c < s;
          c++
        )
          u[c] = arguments[c]
  ...
  function it(e, t) {
    ...
    return (
      he.forEach(Object.keys(s(s({}, e), t)), function (n) {
        var i = c[n] || o,
          a = i(e[n], t[n], n)
        ;(he.isUndefined(a) && i !== u) || (r[n] = a)
      }),
      r
    )
  }
  var at,
    st = function (e) {
      ...
      if (
        ...
        (t.url = ke(nt(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer)),
        s &&
          a.set(
            'Authorization',
            'Basic ' +
        ...
        if (Ue.hasStandardBrowserEnv || Ue.hasStandardBrowserWebWorkerEnv) a.setContentType(void 0)
        else if (he.isFunction(r.getHeaders)) {
          var u = r.getHeaders(),
      ...
      if (
        ...
        (n && he.isFunction(n) && (n = n(t)), n || (!1 !== n && tt(t.url)))
      ) {
        var f = o && i && rt.read(i)
        f && a.set(o, f)
      }
        ...
        return new Promise(function (t, r) {
          ...
          if (
            ...
            (v.onerror = function (t) {
              var n = new de(t && t.message ? t.message : 'Network Error', de.ERR_NETWORK, e, v)
            ...
            (v.ontimeout = function () {
              ...
              ;(u.timeoutErrorMessage && (t = u.timeoutErrorMessage),
                r(new de(t, n.clarifyTimeoutError ? de.ETIMEDOUT : de.ECONNABORTED, e, v)),
                (v = null))
            }),
            ...
            he.isUndefined(u.withCredentials) || (v.withCredentials = !!u.withCredentials),
          ...
          O && -1 === Ue.protocols.indexOf(O)
            ? r(new de('Unsupported protocol ' + O + ':', de.ERR_BAD_REQUEST, e))
            : v.send(c || null)
        })
      },
    ct = function (e, t) {
    ...
    dt = he.isFunction,
    vt = { Request: (at = he.global).Request, Response: at.Response },
    yt = he.global,
    ...
    wt = function (e) {
      var t = (e = he.merge.call({ skipUndefined: !0 }, vt, e)),
        r = t.fetch,
        n = t.Request,
        o = t.Response,
        i = r ? dt(r) : 'function' == typeof fetch,
        a = dt(n),
        c = dt(o)
      if (!i) return !1
      var f,
        ...
        v =
          ...
          l &&
          gt(function () {
            return he.isReadableStream(new o('').body)
          }),
        y = {
          stream:
            v &&
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 4:
                      ...
                      return (
                        (r = new n(Ue.origin, { method: 'POST', body: t })),
                        (e.next = 8),
                        r.arrayBuffer()
                      )
                    case 8:
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        ...
                        (h = i.cancelToken),
                        (m = i.timeout),
                        (w = i.onDownloadProgress),
                        (E = i.onUploadProgress),
                        (O = i.responseType),
                        (S = i.headers),
                        (x = i.withCredentials),
                        (R = void 0 === x ? 'same-origin' : x),
                        (k = i.fetchOptions),
                        (j = r || fetch),
                        (O = O ? (O + '').toLowerCase() : 'text'),
                        (T = ct([p, h && h.toAbortSignal()], m)),
                        (A = null),
                        (P =
                          T &&
                          T.unsubscribe &&
                    ...
                    case 13:
                      ...
                      ;((N = new n(c, { method: 'POST', body: l, duplex: 'half' })),
                        he.isFormData(l) &&
                        ...
                        N.body &&
                          ...
                          (F = U[0]),
                          (B = U[1]),
                          (l = ht(N.body, 65536, F, B))))
                    case 17:
                      return (
                        he.isString(R) || (R = R ? 'include' : 'omit'),
                        (D = a && 'credentials' in n.prototype),
                        (I = s(
                          s({}, k),
                          {},
                          {
                    ...
                    case 23:
                      return (
                        ...
                        v &&
                          ...
                          (H = he.toFiniteNumber(q.headers.get('content-length'))),
                          (J = (w && Ze(H, Qe(et(w), !0))) || []),
                          (W = b(J, 2)),
                          (K = W[0]),
                          (V = W[1]),
                          (q = new o(
                            ht(q.body, 65536, K, function () {
                              ;(V && V(), P && P())
                            }),
                            z,
                          ))),
                    ...
                    case 36:
                      ...
                      throw Object.assign(new de('Network Error', de.ERR_NETWORK, t, A), {
                        cause: e.t2.cause || e.t2,
                      })
                    case 41:
                      throw de.from(e.t2, e.t2 && e.t2.code, t, A)
                    case 42:
                    case 'end':
                      return e.stop()
                  }
    ...
    Ot = function (e) {
      for (
        var t,
          ...
          n = e ? e.env : {},
          o = n.fetch,
          i = [n.Request, n.Response, o],
          a = i.length,
          s = Et;
        a--;

      )
        ((t = i[a]), void 0 === (r = s.get(t)) && s.set(t, (r = a ? new Map() : wt(n))), (s = r))
      return r
    }
  Ot()
  var St = { http: null, xhr: ut, fetch: { get: Ot } }
  he.forEach(St, function (e, t) {
    if (e) {
      try {
  ...
  var xt = function (e) {
    ...
    kt = function (e, t) {
      for (var r, n, o = (e = he.isArray(e) ? e : [e]).length, i = {}, a = 0; a < o; a++) {
        var s = void 0
        if (((n = r = e[a]), !Rt(r) && void 0 === (n = St[(s = String(r)).toLowerCase()])))
          throw new de("Unknown adapter '".concat(s, "'"))
        if (n && (he.isFunction(n) || (n = n.get(t)))) break
        i[s || '#' + a] = n
      }
      if (!n) {
        ...
        function (t) {
          return (
            Ve(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Ke.call(e, e.transformResponse, t.response)),
  ...
  ;((Pt.transitional = function (e, t, r) {
    function n(e, t) {
      return "[Axios v1.12.2] Transitional option '" + e + "'" + t + (r ? '. ' + r : '')
    }
      ...
      return (
        y(e, [
              ...
              ;(void 0 !== n &&
                ...
                null != o &&
                  (he.isFunction(o)
                    ...
                    : Nt.assertOptions(o, { encode: _t.function, serialize: _t.function }, !0)),
                ...
                Nt.assertOptions(
                  t,
                  { baseUrl: _t.spelling('baseURL'), withXsrfToken: _t.spelling('withXSRFToken') },
                  !0,
                ),
          ...
          },
          {
            ...
            value: function (e) {
              return ke(
                nt((e = it(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
                e.params,
                e.paramsSerializer,
              )
            },
  ...
  var qt = (function e(t) {
    ...
    return (
      he.extend(n, Ut.prototype, r, { allOwnKeys: !0 }),
