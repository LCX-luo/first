...
export default {
    ...
    methods: {
        // 处理鼠标悬停事件
        handleMouseOver() {
            this.imageStyle.transform = 'rotate(10deg) scale(1.1)';
            this.imageStyle.boxShadow = '0 5px 15px rgba(0,0,0,0.2)';
        },
        // 处理鼠标离开事件
        handleMouseOut() {
            this.imageStyle.transform = 'scale(1)';
            this.imageStyle.boxShadow = 'none';
        }
    }
}
</script>
...
.main-introducemyself img {
    ...
    border-radius: 50%;
    flex-shrink: 0;
    transition: all 0.3s ease; /* 统一的过渡效果 */
}
